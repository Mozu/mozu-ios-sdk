...
@protocol MOZUEntityContainerCollection
@end
...
*/
@interface MOZUEntityContainerCollection : JSONModel<MOZUEntityContainerCollection>
...
*/
@property(nonatomic) NSArray<MOZUEntityContainer> *items;
