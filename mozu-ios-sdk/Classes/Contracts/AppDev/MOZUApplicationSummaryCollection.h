...
#import "JSONModel.h"
#import "MOZUApplicationSummary.h"



@protocol MOZUApplicationSummaryCollection
@end
...
*/
@interface MOZUApplicationSummaryCollection : JSONModel<MOZUApplicationSummaryCollection>
...
*/
@property(nonatomic) NSArray<MOZUApplicationSummary> *items;
