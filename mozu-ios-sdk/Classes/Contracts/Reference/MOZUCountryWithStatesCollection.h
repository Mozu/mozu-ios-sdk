...
#import "JSONModel.h"
#import "MOZUCountryWithStates.h"



@protocol MOZUCountryWithStatesCollection
@end
...
*/
@interface MOZUCountryWithStatesCollection : JSONModel<MOZUCountryWithStatesCollection>
...
*/
@property(nonatomic) NSArray<MOZUCountryWithStates> *items;
