...
@protocol MOZUPriceListCollection
@end
...
*/
@interface MOZUPriceListCollection : JSONModel<MOZUPriceListCollection>
...
*/
@property(nonatomic) NSArray<MOZUProductAdminPriceList> *items;
