...
@protocol MOZUPriceListEntryCollection
@end
...
*/
@interface MOZUPriceListEntryCollection : JSONModel<MOZUPriceListEntryCollection>
...
*/
@property(nonatomic) NSArray<MOZUPriceListEntry> *items;
