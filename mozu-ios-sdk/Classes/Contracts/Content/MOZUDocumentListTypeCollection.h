...
@protocol MOZUDocumentListTypeCollection
@end
...
*/
@interface MOZUDocumentListTypeCollection : JSONModel<MOZUDocumentListTypeCollection>
...
*/
@property(nonatomic) NSArray<MOZUDocumentListType> *items;
