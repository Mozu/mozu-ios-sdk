...
NSString * const MOZU_X_VOL_TENANT = @"x-vol-tenant";
NSString * const MOZU_X_VOL_SITE = @"x-vol-site";
NSString * const MOZU_X_VOL_CATALOG = @"x-vol-catalog";
NSString * const MOZU_X_VOL_MASTER_CATALOG = @"x-vol-master-catalog";
NSString * const MOZU_X_VOL_SITE_DOMAIN = @"x-vol-site-domain";
NSString * const MOZU_X_VOL_TENANT_DOMAIN = @"x-vol-tenant-domain";
NSString * const MOZU_X_VOL_CORRELATION = @"x-vol-correlation";
