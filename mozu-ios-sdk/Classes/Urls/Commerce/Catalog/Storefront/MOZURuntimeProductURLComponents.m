...
+ (MOZUURLComponents *)URLComponentsForGetProductOperationWithProductCode:(NSString *)productCode variationProductCode:(NSString *)variationProductCode allowInactive:(NSNumber *)allowInactive skipInventoryCheck:(NSNumber *)skipInventoryCheck supressOutOfStock404:(NSNumber *)supressOutOfStock404 quantity:(NSNumber *)quantity responseFields:(NSString *)responseFields {
	NSString *template = @"/api/commerce/catalog/storefront/products/{productCode}?variationProductCode={variationProductCode}&allowInactive={allowInactive}&skipInventoryCheck={skipInventoryCheck}&supressOutOfStock404={supressOutOfStock404}&quantity={quantity}&responseFields={responseFields}";
	NSDictionary *params = @{
		@"productCode" : productCode,
...
+ (MOZUURLComponents *)URLComponentsForGetProductForIndexingOperationWithProductCode:(NSString *)productCode productVersion:(NSNumber *)productVersion responseFields:(NSString *)responseFields {
	NSString *template = @"/api/commerce/catalog/storefront/products/indexing/{productCode}&productVersion={productVersion}?responseFields={responseFields}";
	NSDictionary *params = @{
		@"productCode" : productCode,
...
+ (MOZUURLComponents *)URLComponentsForConfiguredProductOperationWithProductCode:(NSString *)productCode includeOptionDetails:(NSNumber *)includeOptionDetails skipInventoryCheck:(NSNumber *)skipInventoryCheck quantity:(NSNumber *)quantity responseFields:(NSString *)responseFields {
	NSString *template = @"/api/commerce/catalog/storefront/products/{productCode}/configure?includeOptionDetails={includeOptionDetails}&skipInventoryCheck={skipInventoryCheck}&quantity={quantity}&responseFields={responseFields}";
	NSDictionary *params = @{
		@"productCode" : productCode,
...
+ (MOZUURLComponents *)URLComponentsForValidateProductOperationWithProductCode:(NSString *)productCode skipInventoryCheck:(NSNumber *)skipInventoryCheck quantity:(NSNumber *)quantity responseFields:(NSString *)responseFields {
	NSString *template = @"/api/commerce/catalog/storefront/products/{productCode}/validate?skipInventoryCheck={skipInventoryCheck}&quantity={quantity}&responseFields={responseFields}";
	NSDictionary *params = @{
		@"productCode" : productCode,
		@"skipInventoryCheck" : skipInventoryCheck ? skipInventoryCheck : @"",
		@"quantity" : quantity ? quantity : @"",
