...
+ (MOZUClient *)clientForGetPublishSetItemsOperationWithCode:(NSString *)code pageSize:(NSNumber *)pageSize startIndex:(NSNumber *)startIndex responseFields:(NSString *)responseFields {
	id url = [MOZUPublishSetSummaryURLComponents URLComponentsForGetPublishSetItemsOperationWithCode:code pageSize:pageSize startIndex:startIndex responseFields:responseFields];
	id verb = @"GET";
	MOZUClient *client = [[MOZUClient alloc] initWithResourceURLComponents:url verb:verb];
