...
+(MOZUClient*)clientForCreatePackageShipmentsOperationWithPackageIds:(packageIds)packageIds returnId:(NSString*)returnId userClaims:(MOZUUserAuthTicket*)userClaims;
