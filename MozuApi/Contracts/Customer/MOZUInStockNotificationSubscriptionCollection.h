...
@protocol MOZUInStockNotificationSubscriptionCollection
@end
...
*/
@interface MOZUInStockNotificationSubscriptionCollection : JSONModel<MOZUInStockNotificationSubscriptionCollection>
...
*/
@property(nonatomic) NSArray<MOZUInStockNotificationSubscription>* items;
