...
@protocol MOZUCustomerAccountCollection
@end
...
*/
@interface MOZUCustomerAccountCollection : JSONModel<MOZUCustomerAccountCollection>
...
*/
@property(nonatomic) NSArray<MOZUCustomerAccount>* items;
