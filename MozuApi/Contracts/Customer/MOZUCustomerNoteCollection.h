...
@protocol MOZUCustomerNoteCollection
@end
...
*/
@interface MOZUCustomerNoteCollection : JSONModel<MOZUCustomerNoteCollection>
...
*/
@property(nonatomic) NSArray<MOZUCustomerNote>* items;
