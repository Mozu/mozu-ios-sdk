...
@protocol MOZUCustomerAttributeCollection
@end
...
*/
@interface MOZUCustomerAttributeCollection : JSONModel<MOZUCustomerAttributeCollection>
...
*/
@property(nonatomic) NSArray<MOZUCustomerAttribute>* items;
