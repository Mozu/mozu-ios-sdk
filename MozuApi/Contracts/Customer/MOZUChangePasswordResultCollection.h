...
#import "JSONModel.h"
#import "MOZUChangePasswordResult.h"



@protocol MOZUChangePasswordResultCollection
@end
...
*/
@interface MOZUChangePasswordResultCollection : JSONModel<MOZUChangePasswordResultCollection>
...
*/
@property(nonatomic) NSArray<MOZUChangePasswordResult> *items;
