...
@protocol MOZUCreditTransactionCollection
@end
...
*/
@interface MOZUCreditTransactionCollection : JSONModel<MOZUCreditTransactionCollection>
...
*/
@property(nonatomic) NSArray<MOZUCreditTransaction>* items;
