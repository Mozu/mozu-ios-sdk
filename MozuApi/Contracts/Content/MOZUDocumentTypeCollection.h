...
@protocol MOZUDocumentTypeCollection
@end
...
*/
@interface MOZUDocumentTypeCollection : JSONModel<MOZUDocumentTypeCollection>
...
*/
@property(nonatomic) NSArray<MOZUDocumentType> *items;
