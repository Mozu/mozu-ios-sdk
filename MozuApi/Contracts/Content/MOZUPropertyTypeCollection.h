...
@protocol MOZUPropertyTypeCollection
@end
...
*/
@interface MOZUPropertyTypeCollection : JSONModel<MOZUPropertyTypeCollection>
...
*/
@property(nonatomic) NSArray<MOZUPropertyType> *items;
