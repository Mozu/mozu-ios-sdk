...
#import "JSONModel.h"
#import "MOZUDocumentDraftSummary.h"



@protocol MOZUDocumentDraftSummaryPagedCollection
@end
...
*/
@interface MOZUDocumentDraftSummaryPagedCollection : JSONModel<MOZUDocumentDraftSummaryPagedCollection>
...
*/
@property(nonatomic) NSArray<MOZUDocumentDraftSummary> *items;
