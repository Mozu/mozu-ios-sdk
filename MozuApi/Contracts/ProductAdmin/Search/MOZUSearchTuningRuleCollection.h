...
@protocol MOZUSearchTuningRuleCollection
@end
...
*/
@interface MOZUSearchTuningRuleCollection : JSONModel<MOZUSearchTuningRuleCollection>
...
*/
@property(nonatomic) NSArray<MOZUSearchTuningRule> *items;
