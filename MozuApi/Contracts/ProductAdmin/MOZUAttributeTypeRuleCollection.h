...
#import "JSONModel.h"
#import "MOZUAttributeTypeRule.h"



@protocol MOZUAttributeTypeRuleCollection
@end
...
*/
@interface MOZUAttributeTypeRuleCollection : JSONModel<MOZUAttributeTypeRuleCollection>
...
*/
@property(nonatomic) NSArray<MOZUAttributeTypeRule> *items;
