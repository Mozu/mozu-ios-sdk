...
@protocol MOZUSoftAllocationCollection
@end
...
*/
@interface MOZUSoftAllocationCollection : JSONModel<MOZUSoftAllocationCollection>
...
*/
@property(nonatomic) NSArray<MOZUSoftAllocation> *items;
