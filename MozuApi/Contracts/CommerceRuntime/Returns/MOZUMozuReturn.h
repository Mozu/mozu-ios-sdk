...
*/
@property(nonatomic) NSDecimalNumber* lossTotal;
...
*/
@property(nonatomic) NSDecimalNumber* productLossTaxTotal;
...
*/
@property(nonatomic) NSDecimalNumber* productLossTotal;
...
*/
@property(nonatomic) NSDecimalNumber* refundAmount;
...
*/
@property(nonatomic) NSDecimalNumber* shippingLossTaxTotal;
...
*/
@property(nonatomic) NSDecimalNumber* shippingLossTotal;
