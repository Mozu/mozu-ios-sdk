...
@protocol MOZUChannelGroupCollection
@end
...
*/
@interface MOZUChannelGroupCollection : JSONModel<MOZUChannelGroupCollection>
...
*/
@property(nonatomic) NSArray<MOZUChannelGroup> *items;
