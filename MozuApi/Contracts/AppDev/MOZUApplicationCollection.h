...
@protocol MOZUApplicationCollection
@end
...
*/
@interface MOZUApplicationCollection : JSONModel<MOZUApplicationCollection>
...
*/
@property(nonatomic) NSArray<MOZUAppDevApplication> *items;
