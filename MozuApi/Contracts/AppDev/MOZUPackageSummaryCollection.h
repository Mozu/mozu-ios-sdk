...
#import "JSONModel.h"
#import "MOZUPackageSummary.h"



@protocol MOZUPackageSummaryCollection
@end
...
*/
@interface MOZUPackageSummaryCollection : JSONModel<MOZUPackageSummaryCollection>
...
*/
@property(nonatomic) NSArray<MOZUPackageSummary> *items;
